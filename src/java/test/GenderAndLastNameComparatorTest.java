...
public class GenderAndLastNameComparatorTest {
    private final Record EGWENE_ALVERE = new Record("al'Vere", "Egwene", "", "F", "green", null);
    private final Record SIUN_SANCHE = new Record("Sanche", "Siun", "B", "F", "blue", null);
    private final Record RAND_ALTHOR = new Record("al'Thor", "Rand", "", "M", "black", null);
    private final Record GARETH_BRYNE = new Record("Bryne", "Gareth", "W", "M", "white", null);
    ...
    public void comparesDifferentGendersAndLastNames() {
        ...
        Record EGWENE_ALVERE_AS_MAN = new Record("al'Vere", "Egwene", "", "M", "green", null);
        ...
        Record RAND_ALTHOR_AS_WOMAN = new Record("al'Thor", "Rand", "", "F", "black", null);
